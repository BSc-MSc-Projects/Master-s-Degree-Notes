...
In realtà, tutta la prima parte della formula è una distanza geometrica, nel caso dei sistemi di navigazione satellitare l'utente misura una pseudo-distanza: è la distanza + c + l'errore dell'orologio ed è chiamato \textbf{pseudo-range}. (copia slides).
\\
