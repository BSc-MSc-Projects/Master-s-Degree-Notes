...
\end{itemize}
Le operazioni chiamate quando ad esempio si fa un \texttt{echo "qualcosa" > /dev/example} avremo in dmesg le print chiamate, vengono fatte n write perché la echo cerca di scrivere n byte e se ne vede ritornare uno alla volta come risultato della scrittura.\\Potevamo fare qualunque cosa con questo driver, davvero sbizzarritevi provateci anche voi e fate il vostro stupendo driver.\\\\Il secondo esempio: 
